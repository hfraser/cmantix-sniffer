 ...
 * @version   SVN: $Id: DisallowSpaceIndentSniff.php 2373 2011-01-13 21:12:36Z suhemi $
 * @link      http://pear.typo3.org
 */
class Cmantix_Sniffs_WhiteSpace_DisallowSpaceIndentSniff implements PHP_CodeSniffer_Sniff
{
	/**
	 ...
	 * @param string               $tokenIsDocComment Document comments.
	 *
	 * @return void
	 */
	protected function ifSpaceIndent(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $lineContent, $tokenIsDocComment)
	{
		...
		if ($hasIndention) {
			...
			if ($isSpace) {
				...
				$phpcsFile->addError($error, $stackPtr - 1, ' https://dev.c-mantix.com/projects/cmantix/wiki/Coding_Standards');
			}
		}
	}
}
