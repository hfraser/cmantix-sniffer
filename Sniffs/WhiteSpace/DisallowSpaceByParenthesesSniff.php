...
/**
 * Cmantix_Sniffs_WhiteSpace_DisallowSpaceByParenthesesSniff.
 *
 * Throws errors if spaces are used immediately after open parens.
 *
 */
class Cmantix_Sniffs_WhiteSpace_DisallowSpaceByParenthesesSniff implements PHP_CodeSniffer_Sniff
{
