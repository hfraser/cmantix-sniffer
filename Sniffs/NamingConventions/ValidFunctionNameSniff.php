...
/**
 * Cmantix_Sniffs_NamingConventions_ValidFunctionNameSniff.
 *
 * Functions should be named like this_is_my_function()
 * Class methods should be named thisIsMyMethod()
 *
 */
class Cmantix_Sniffs_NamingConventions_ValidFunctionNameSniff extends PEAR_Sniffs_NamingConventions_ValidFunctionNameSniff
{
